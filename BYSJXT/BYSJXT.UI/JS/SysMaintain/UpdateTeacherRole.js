...
function updateTeacherRole(){
    ...
    var teacherGrid = new Ext.grid.Panel({
        ...
        columns: [//配置表格列
                    ...
                    { header: '姓名', dataIndex: 'teacherName', width: 65, sortable: true },
                    { header: '学院', dataIndex: 'collegeName', width: 150, sortable: true },
                    { header: '系所', dataIndex: 'departmentName', width: 150, sortable: true },
                    { header: '权限', dataIndex: 'role', width: 65, sortable: true },
                    { header: '操作', width: 90, renderer: function () { return '<font color=blue>修改</font>'; } }//渲染
			    ]
    });
