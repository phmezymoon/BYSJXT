...
function taskBookMonitor(){
    ...
    var teacherGrid = new Ext.grid.Panel({
        ...
        columns: [//配置表格列
                    ...
                    { header: '申报课题数', dataIndex: 'declaredAmount', width: 80, sortable: true, hidden: true },
                    { header: '已写任务书', dataIndex: 'filledAmount', width: 80, sortable: true },
                    { header: '未写任务书', dataIndex: 'unfilledAmount', width: 80, sortable: true },
